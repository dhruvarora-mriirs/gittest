...
public class UserController {
	...
	@Timed(value = "userInfo.gettingAll.request", histogram = true, percentiles = { 0.95, 0.99 }, extraTags = {
			"version", "1.0" })
	...
	@Timed(value = "userInfo.getting.request", histogram = true, percentiles = { 0.95, 0.99 }, extraTags = { "version",
			"1.0" })
	...
	@Timed(value = "userInfo.postUser.request", histogram = true, percentiles = { 0.95, 0.99 }, extraTags = { "version",
			"1.0" })
	@PostMapping
	@WriteOperation
	...
	@Timed(value = "userInfo.updateUser.request", histogram = true, percentiles = { 0.95, 0.99 }, extraTags = {
			"version", "1.0" })
	...
	@Timed(value = "userInfo.deleteUser.request", histogram = true, percentiles = { 0.95, 0.99 }, extraTags = {
			"version", "1.0" })
