...
public class OAuthConfig {
	...
	@Bean
	public OAuthClient authClient(@Value("${connection.read.timeout.second:60}") final Long timeoutSeconds,
		...
		return new Retrofit.Builder()
				...
				.addCallAdapterFactory(RxJava2CallAdapterFactory.create()).build().create(OAuthClient.class);
	}
